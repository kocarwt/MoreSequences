...
def run_test_generate_points_on_circle():
    ...
    expected = [rg.Point(70.0, 40.0),
                rg.Point(60.0, 57.3),
                rg.Point(40.0, 57.3),
                rg.Point(30.0, 40.0),
                rg.Point(40.0, 22.7),
                rg.Point(60.0, 22.7)]
    circle = rg.Circle(rg.Point(50, 40), 20)
    answer = generate_points_on_circle(circle, 6)
...
def run_test_polygon():
    ...
    circle = rg.Circle(rg.Point(275, 200), 130)
    circle.outline_thickness = 3
    polygon(window, circle, 8, 'black', 5)
...
def run_test_fancy_polygon():
    ...
    circle = rg.Circle(rg.Point(240, 125), 160)
    circle.fill_color = 'green'
    fancy_polygon(window, circle, 20, 8, 'blue', 5)
    window.close_on_mouse_click()
